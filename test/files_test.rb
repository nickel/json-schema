...
class FilesTest < Minitest::Test
  ...
  def test_data_from_oas_3
    schema = {"$schema" => "https://raw.githubusercontent.com/amazon-archives/aws-service-operator/master/vendor/github.com/googleapis/gnostic/OpenAPIv3/openapi-3.0.json","type" => "object", "properties" => {"a" => {"type" => "integer", "nullable" => true}}}
    assert_valid schema_fixture_path('good_schema_1.json'), { "a" => 5 }
